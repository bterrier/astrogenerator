...
double Carteciel::hmsToDegree(QString hms)
{
    ...
    h = list.at(0).left(list.at(0).count()-1).toDouble();

    // On s'occupe des minutes
    m = list.at(1).left(list.at(1).count()-3).toDouble();
